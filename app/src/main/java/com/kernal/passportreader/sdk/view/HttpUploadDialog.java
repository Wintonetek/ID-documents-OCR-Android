...
public class HttpUploadDialog extends DialogFragment implements
    ...
    private String httpPath = "http://101.200.240.34/emailServer/servlet/UploadFileTxt?fileName=";
    ...
    public void onClick(View v) {
        if(NetworkProber.isNetworkAvailable(this.getActivity())){
            if (getResources().getIdentifier("tv_httpupload_ok", "id",
                ...
                {
                    new WriteToPCTask(getActivity(),httpPath
                            ).execute(
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        lparams = new RelativeLayout.LayoutParams(
                (int) (width * 0.65), (int) (width * 0.7*0.6));
        lparams.addRule(RelativeLayout.CENTER_HORIZONTAL);
        lparams.addRule(RelativeLayout.BELOW, getResources().getIdentifier("tv_httpupload_title",
                "id", getActivity().getPackageName()));
